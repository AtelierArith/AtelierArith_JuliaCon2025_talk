...
- For non-English speaking developers, reading and discussing in English is a psychological and time-consuming cost
...
- Edit `<lang>.md` (e.g., `ja.md`) to modify translation results
...
- Support both docstring and Documenter.jl
- Improve efficiency with translation result caching
