...
- 自然言語における $(N \geq 2)$ -language problem が潜在的にあるのでは？
  ...
  - 母国語でドキュメントを書く権利があってもいいのでは?
    - 論理的に言えば日本語で Documenter.jl や Franklin.jl などのエコシステムを用いて文章を書くことは可能
- あるのは経済的な障壁である．
...
- [UnofficialJuliaDoc-ko](https://atelierarith.github.io/UnofficialJuliaDoc-ko/) 韓国語
- [UnofficialJuliaDoc-zh](https://atelierarith.github.io/UnofficialJuliaDoc-zh/) 中国語
...
- [UnofficialJuliaDoc-tr](https://atelierarith.github.io/UnofficialJuliaDoc-tr/) トルコ語
