...
- In Japan especially in industry, C++/Python is widely used. 
  - There is lots of Japanese documentation (including blog post) for C++/Python. 
...
We are trying various backends. I think OpenAI backend is the best.
...
- Introducing DocstringTranslation.jl
